...
def put_bucket_object_worm_configuration(client: _SyncClientImpl, request: models.PutBucketObjectWormConfigurationRequest, **kwargs) -> models.PutBucketObjectWormConfigurationResult:
    """
    put_bucket_object_worm_configuration synchronously
...
def get_bucket_object_worm_configuration(client: _SyncClientImpl, request: models.GetBucketObjectWormConfigurationRequest, **kwargs) -> models.GetBucketObjectWormConfigurationResult:
    """
    get_bucket_object_worm_configuration synchronously
