...
class CreateSelectObjectMetaRequest(serde.RequestModel):
    ...
    _attribute_map = {
        ...
        'csv_meta_request': {'tag': 'input', 'position': 'body', 'rename': 'CsvMetaRequest', 'type': 'xml'},
        'json_meta_request': {'tag': 'input', 'position': 'body', 'rename': 'JsonMetaRequest', 'type': 'xml'},
    }
    ...
    def __init__(
        ...
        bucket: str = None,
        key: str = None,
        csv_meta_request: Optional[CsvMetaRequest] = None,
        json_meta_request: Optional[JsonMetaRequest] = None,
        **kwargs: Any
    ) -> None:
        """
        bucket (str, required): The name of the bucket.
        key (str, required): The full path of the object.
        select_meta_request (SelectMetaRequest, optional): The container that stores SelectMetaRequest information.
        """
        super().__init__(**kwargs)
        self.bucket = bucket
        self.key = key
        self.csv_meta_request = csv_meta_request
        self.json_meta_request = json_meta_request
