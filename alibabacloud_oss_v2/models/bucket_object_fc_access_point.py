...
class ObjectProcessFunctionCompute(serde.Model):
    """
...
class ObjectProcessCustomForwardHeaders(serde.Model):
    """
    The container that stores the custom forward headers list.
    """

    _attribute_map = {
        'custom_forward_header': {'tag': 'xml', 'rename': 'CustomForwardHeader', 'type': '[str]'},
    }
    ...
    def __init__(
        self,
        custom_forward_header: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        custom_forward_header (List[str], optional): The list of custom forward headers.
        """
        super().__init__(**kwargs)
...
class ObjectProcessAllowedFeatures(serde.Model):
    """
    The container that stores allowed features.
    """

    _attribute_map = {
        'allowed_feature': {'tag': 'xml', 'rename': 'AllowedFeature', 'type': '[str]'},
    }
    ...
    def __init__(
        self,
        allowed_feature: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        allowed_feature (List[str], optional): Specifies that Function Compute supports Range GetObject requests.
        """
        super().__init__(**kwargs)
...
class AccessPointActions(serde.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        action (List[str], optional): The supported OSS API operations. Only the GetObject operation is supported.
        """
        super().__init__(**kwargs)
        self.action = action
...
class ObjectProcessAdditionalFeatures(serde.Model):
    """
    ...
    _dependency_map = {
        'CustomForwardHeaders': {'new': lambda: ObjectProcessCustomForwardHeaders()},
    }

    def __init__(
            self,
            custom_forward_headers: Optional[ObjectProcessCustomForwardHeaders] = None,
            **kwargs: Any
    ) -> None:
        """
        custom_forward_headers (CustomForwardHeaders, optional): The container that stores the custom forward headers list.
        """
        super().__init__(**kwargs)
...
class ContentTransformation(serde.Model):
    ...
    _dependency_map = { 
        'FunctionCompute': {'new': lambda: ObjectProcessFunctionCompute()},
        'AdditionalFeatures': {'new': lambda: ObjectProcessAdditionalFeatures()},
    }

    def __init__(
        self,
        function_compute: Optional[ObjectProcessFunctionCompute] = None,
        additional_features: Optional[ObjectProcessAdditionalFeatures] = None,
        **kwargs: Any
    ) -> None:
        """
...
class TransformationConfigurations(serde.Model):
    ...
    _attribute_map = {
        'transformation_configuration': {'tag': 'xml', 'rename': 'TransformationConfiguration', 'type': '[TransformationConfiguration]'},
    }
    ...
    def __init__(
        self,
        transformation_configuration: Optional[List[TransformationConfiguration]] = None,
        **kwargs: Any
    ) -> None:
        """
        transformation_configuration (List[TransformationConfiguration], optional): The container that stores the transformation configurations.
        """
        super().__init__(**kwargs)
...
class AccessPointsForObjectProcess(serde.Model):
    ...
    _attribute_map = { 
        'access_point_for_object_process': {'tag': 'xml', 'rename': 'AccessPointForObjectProcess', 'type': '[AccessPointForObjectProcess]'},
    }
    ...
    def __init__(
        self,
        access_point_for_object_process: Optional[List[AccessPointForObjectProcess]] = None,
        **kwargs: Any
    ) -> None:
        """
        access_point_for_object_process (List[AccessPointForObjectProcess], optional): The container that stores information about a single Object FC Access Point.
        """
        super().__init__(**kwargs)
...
class ObjectProcessConfiguration(serde.Model):
    ...
    _dependency_map = {
        'AllowedFeatures': {'new': lambda: ObjectProcessAllowedFeatures()},
        'TransformationConfigurations': {'new': lambda: TransformationConfigurations()},
    }

    def __init__(
        self,
        allowed_features: Optional[ObjectProcessAllowedFeatures] = None,
...
class WriteGetObjectResponseRequest(serde.RequestModel):
    ...
    _attribute_map = {
        ...
        'request_token': {'tag': 'input', 'position': 'header', 'rename': 'x-oss-request-token', 'type': 'str', 'required': True},
