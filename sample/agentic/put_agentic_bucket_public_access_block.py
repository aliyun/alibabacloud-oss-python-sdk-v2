...
parser = argparse.ArgumentParser(description="put agentic bucket public access block sample")
...
def main():
    ...
    result = client.put_agentic_bucket_public_access_block(oss_agentic.models.PutAgenticBucketPublicAccessBlockRequest(
        bucket=args.bucket,
