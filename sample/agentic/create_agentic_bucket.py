...
parser = argparse.ArgumentParser(description="create agentic bucket sample")
...
def main():
    ...
    result = client.create_agentic_bucket(oss_agentic.models.CreateAgenticBucketRequest(
        bucket=args.bucket,
