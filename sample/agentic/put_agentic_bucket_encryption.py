...
parser = argparse.ArgumentParser(description="put agentic bucket encryption sample")
...
def main():
    ...
    result = client.put_agentic_bucket_encryption(oss_agentic.models.PutAgenticBucketEncryptionRequest(
        bucket=args.bucket,
