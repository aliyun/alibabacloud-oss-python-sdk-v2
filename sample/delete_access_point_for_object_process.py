...
parser = argparse.ArgumentParser(description="delete access point for object process sample")
...
def main():
    ...
    result = client.delete_access_point_for_object_process(oss.DeleteAccessPointForObjectProcessRequest(
            bucket=args.bucket,
