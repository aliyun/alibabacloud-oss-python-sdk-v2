...
def main():
    ...
    print(f'status code: {result.status_code},'
            ...
            f' status: {result.access_points_for_object_process.access_point_for_object_process[0].status},'
            f' allow anonymous access for object process: {result.access_points_for_object_process.access_point_for_object_process[0].allow_anonymous_access_for_object_process},'
            f' access point name for object process: {result.access_points_for_object_process.access_point_for_object_process[0].access_point_name_for_object_process},'
            f' access point for object process alias: {result.access_points_for_object_process.access_point_for_object_process[0].access_point_for_object_process_alias},'
            f' access point name: {result.access_points_for_object_process.access_point_for_object_process[0].access_point_name},'
    )

    if result.access_points_for_object_process.access_point_for_object_process:
        for r in result.access_points_for_object_process.access_point_for_object_process:
