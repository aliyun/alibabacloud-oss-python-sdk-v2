...
parser = argparse.ArgumentParser(description="update dataset sample")
...
parser.add_argument('--description', help='The updated description of the dataset.')
...
def main():
    ...
    result = client.update_dataset(oss_dataprocess.models.UpdateDatasetRequest(
        bucket=args.bucket,
