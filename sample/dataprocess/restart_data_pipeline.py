...
parser = argparse.ArgumentParser(description="restart data pipeline sample")
...
def main():
    ...
    result = client.restart_data_pipeline(oss_dataprocess.models.RestartDataPipelineRequest(
