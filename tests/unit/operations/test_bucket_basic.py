...
from alibabacloud_oss_v2.operations import bucket_basic as operations
...
class TestBucketBasic(TestOperations):
    ...
    def test_put_bucket(self):
        ...
        result = operations.put_bucket(self.client, request)
    ...
    def test_put_bucket_acl(self):
        ...
        result = operations.put_bucket_acl(self.client, request)
    ...
    def test_get_bucket_acl(self):
        ...
        result = operations.get_bucket_acl(self.client, request)
        self.assertEqual('https://bucket.oss-cn-hangzhou.aliyuncs.com/?acl=', self.request_dump.url)
    ...
    def test_list_objects_v2(self):
        ...
        result = operations.list_objects_v2(self.client, request)
    ...
    def test_get_bucket_stat(self):
        ...
        result = operations.get_bucket_stat(self.client, request)
    ...
    def test_list_objects(self):
        ...
        result = operations.list_objects(self.client, request)
    ...
    def test_get_bucket_info(self):
        ...
        result = operations.get_bucket_info(self.client, request)
    ...
    def test_get_bucket_location(self):
        ...
        result = operations.get_bucket_location(self.client, request)
    ...
    def test_put_bucket_versioning(self):
        ...
        result = operations.put_bucket_versioning(self.client, request)
    ...
    def test_get_bucket_versioning(self):
        ...
        result = operations.get_bucket_versioning(self.client, request)
        self.assertEqual('https://bucket.oss-cn-hangzhou.aliyuncs.com/?versioning=', self.request_dump.url)
        self.assertEqual('GET', self.request_dump.method)
    ...
    def test_list_object_versions(self):
        ...
        result = operations.list_object_versions(self.client, request)
    ...
    def test_list_object_versions_encoding_type(self):
