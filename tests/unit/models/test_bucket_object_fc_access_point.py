...
class TestCreateAccessPointForObjectProcess(unittest.TestCase):
    def test_constructor_request(self):
        ...
        request = model.CreateAccessPointForObjectProcessRequest(
            ...
            create_access_point_for_object_process_configuration=model.CreateAccessPointForObjectProcessConfiguration(
                ...
                object_process_configuration=model.ObjectProcessConfiguration(
                    allowed_features=model.ObjectProcessAllowedFeatures(
                    ...
                    transformation_configurations=model.TransformationConfigurations(
                        transformation_configuration=[model.TransformationConfiguration(
                            ...
                            content_transformation=model.ContentTransformation(
                                function_compute=model.ObjectProcessFunctionCompute(
                                ...
                                additional_features=model.ObjectProcessAdditionalFeatures(
                                    custom_forward_headers=model.ObjectProcessCustomForwardHeaders(
                                        custom_forward_header=['header1', 'header2'],
                                    ),
                                ),
                            ),
                        ), model.TransformationConfiguration(
                            actions=model.AccessPointActions(
                                action=['GetObject-Range', 'PutObject'],
                            ),
                            content_transformation=model.ContentTransformation(
                                function_compute=model.ObjectProcessFunctionCompute(
                                    function_assume_role_arn='acs:ram::111933544165****:role/aliyunfcdefaultrole',
                                ...
                                additional_features=model.ObjectProcessAdditionalFeatures(
                                    custom_forward_headers=model.ObjectProcessCustomForwardHeaders(
                                        custom_forward_header=['header2', 'header4'],
                                    ),
                                ),
                            ),
                        )],
        ...
        self.assertEqual('GetObject-Range', request.create_access_point_for_object_process_configuration.object_process_configuration.allowed_features.allowed_feature[0])
        self.assertEqual('GetObject', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].actions.action[0])
        self.assertEqual('acs:ram::111933544165****:role/aliyunfcdefaultrole', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_assume_role_arn)
        self.assertEqual('acs:fc:cn-qingdao:111933544165****:services/test-oss-fc.LATEST/functions/fc-01',
                         request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_arn)
        self.assertEqual('header1', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[0])
        self.assertEqual('header2', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[1])
        self.assertEqual('GetObject-Range', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].actions.action[0])
        self.assertEqual('PutObject', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].actions.action[1])
        self.assertEqual('acs:ram::111933544165****:role/aliyunfcdefaultrole', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.function_compute.function_assume_role_arn)
        self.assertEqual('acs:fc:cn-qingdao:111933544165****:services/test-oss-fc.LATEST/functions/fc-01',
                         request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.function_compute.function_arn)
        self.assertEqual('header2', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.additional_features.custom_forward_headers.custom_forward_header[0])
        self.assertEqual('header4', request.create_access_point_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.additional_features.custom_forward_headers.custom_forward_header[1])
                ...
                object_process_configuration=model.ObjectProcessConfiguration(
                    ...
                    transformation_configurations=model.TransformationConfigurations(
                        transformation_configuration=[model.TransformationConfiguration(
                            ...
                            content_transformation=model.ContentTransformation(
                                function_compute=model.ObjectProcessFunctionCompute(
                                    function_assume_role_arn='string',
                                    function_arn='string',
                                ),
                            ),
                        )],
...
class TestListAccessPointsForObjectProcess(unittest.TestCase):
    ...
    def test_constructor_result(self):
        ...
        result = model.ListAccessPointsForObjectProcessResult(
            ...
            access_points_for_object_process=model.AccessPointsForObjectProcess(
                access_point_for_object_process=[model.AccessPointForObjectProcess(
                    status='enabled',
                    allow_anonymous_access_for_object_process='test_allow_anonymous_access_for_object_process',
                    access_point_name_for_object_process='fc-ap-01',
                    access_point_for_object_process_alias='fc-ap-01-3b00521f653d2b3223680ec39dbbe2****-opapalias',
        ...
        self.assertEqual('111933544165****', result.account_id)
        self.assertEqual('enabled', result.access_points_for_object_process.access_point_for_object_process[0].status)
        self.assertEqual('test_allow_anonymous_access_for_object_process', result.access_points_for_object_process.access_point_for_object_process[0].allow_anonymous_access_for_object_process)
        self.assertEqual('fc-ap-01', result.access_points_for_object_process.access_point_for_object_process[0].access_point_name_for_object_process)
        self.assertEqual('fc-ap-01-3b00521f653d2b3223680ec39dbbe2****-opapalias', result.access_points_for_object_process.access_point_for_object_process[0].access_point_for_object_process_alias)
        self.assertEqual('fc-01', result.access_points_for_object_process.access_point_for_object_process[0].access_point_name)
        self.assertEqual('enabled', result.access_points_for_object_process.access_point_for_object_process[1].status)
        self.assertEqual('test_allow_anonymous_access_for_object_process', result.access_points_for_object_process.access_point_for_object_process[1].allow_anonymous_access_for_object_process)
        self.assertEqual('fc-ap-01', result.access_points_for_object_process.access_point_for_object_process[1].access_point_name_for_object_process)
        self.assertEqual('fc-ap-01-3b00521f653d2b3223680ec39dbbe2****-opapalias', result.access_points_for_object_process.access_point_for_object_process[1].access_point_for_object_process_alias)
        self.assertEqual('fc-01', result.access_points_for_object_process.access_point_for_object_process[1].access_point_name)
    ...
    def test_deserialize_result(self):
        ...
        self.assertEqual('fc-ap-01-3b00521f653d2b3223680ec39dbbe2****-opapalias', result.access_points_for_object_process.access_point_for_object_process[0].access_point_for_object_process_alias)
        self.assertEqual('fc-01', result.access_points_for_object_process.access_point_for_object_process[0].access_point_name)
        self.assertEqual('enable', result.access_points_for_object_process.access_point_for_object_process[0].status)
...
class TestPutAccessPointConfigForObjectProcess(unittest.TestCase):
    def test_constructor_request(self):
                    ...
                    transformation_configurations=model.TransformationConfigurations(
                        transformation_configuration=[model.TransformationConfiguration(
                            ...
                            content_transformation=model.ContentTransformation(
                                ...
                                additional_features=model.ObjectProcessAdditionalFeatures(
                                    custom_forward_headers=model.ObjectProcessCustomForwardHeaders(
                                        custom_forward_header=['header3', 'header4'],
                                    ),
                                ),
                            ),
                        )],
        ...
        self.assertEqual('GetObject-Range', request.put_access_point_config_for_object_process_configuration.object_process_configuration.allowed_features.allowed_feature[0])
        self.assertEqual('GetObject', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].actions.action[0])
        self.assertEqual('acs:oss:cn-qingdao:111933544165****:services/oss-fc.LATEST/functions/oss-fc-fc-02',
                         request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_assume_role_arn)
        self.assertEqual('acs:ram::111933544165****:role/aliyunfcdefaultrole', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_arn)
        self.assertEqual('header1', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[0])
        self.assertEqual('header2', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[1])
        self.assertEqual('O', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].actions.action[0])
        self.assertEqual('b', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].actions.action[1])
        self.assertEqual('acs:oss:cn-qingdao:111933544165****:services/oss-fc.LATEST/functions/oss-fc-fc-02',
                         request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.function_compute.function_assume_role_arn)
        self.assertEqual('acs:ram::111933544165****:role/aliyunfcdefaultrole', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.function_compute.function_arn)
        self.assertEqual('header3', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.additional_features.custom_forward_headers.custom_forward_header[0])
        self.assertEqual('header4', request.put_access_point_config_for_object_process_configuration.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.additional_features.custom_forward_headers.custom_forward_header[1])
    ...
    def test_serialize_request_with_put_access_point_config(self):
                ...
                object_process_configuration=model.ObjectProcessConfiguration(
                    ...
                    transformation_configurations=model.TransformationConfigurations(
                        transformation_configuration=[model.TransformationConfiguration(
                            ...
                            content_transformation=model.ContentTransformation(
                                function_compute=model.ObjectProcessFunctionCompute(
                                    function_assume_role_arn='acs:ram::111933544165****:role/aliyunossobjectfcforossdefaultrole',
                                    function_arn='acs:oss:cn-qingdao:111933544165****:services/oss-fc.LATEST/functions/oss-fc-02',
                                ),
                            ),
                        )],
                    ),
...
class TestGetAccessPointConfigForObjectProcess(unittest.TestCase):
    ...
    def test_constructor_result(self):
        ...
        self.assertEqual(True, result.public_access_block_configuration.block_public_access)
        self.assertEqual('GetObject-Range', result.object_process_configuration.allowed_features.allowed_feature[0])
        self.assertEqual('GetObject', result.object_process_configuration.transformation_configurations.transformation_configuration[0].actions.action[0])
        self.assertEqual('acs:oss:cn-qingdao:111933544165****:services/oss-fc.LATEST/functions/oss-fc-fc-02', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_assume_role_arn)
        self.assertEqual('acs:ram::111933544165****:role/aliyunfcdefaultrole', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_arn)
        self.assertEqual('header1', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[0])
        self.assertEqual('header2', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[1])
        self.assertEqual('c', result.object_process_configuration.transformation_configurations.transformation_configuration[1].actions.action[0])
        self.assertEqual('e', result.object_process_configuration.transformation_configurations.transformation_configuration[1].actions.action[1])
        self.assertEqual('acs:oss:cn-qingdao:111933544165****:services/oss-fc.LATEST/functions/oss-fc-fc-02', result.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.function_compute.function_assume_role_arn)
        self.assertEqual('acs:ram::111933544165****:role/aliyunfcdefaultrole', result.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.function_compute.function_arn)
        self.assertEqual('header3', result.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.additional_features.custom_forward_headers.custom_forward_header[0])
        self.assertEqual('header4', result.object_process_configuration.transformation_configurations.transformation_configuration[1].content_transformation.additional_features.custom_forward_headers.custom_forward_header[1])
        self.assertEqual('test_allow_anonymous_access_for_object_process', result.allow_anonymous_access_for_object_process)
    ...
    def test_deserialize_result(self):
                ...
                <ContentTransformation>
                  ...
                  <AdditionalFeatures>
                    <CustomForwardHeaders>
                      <CustomForwardHeader>header1</CustomForwardHeader>
                      <CustomForwardHeader>header2</CustomForwardHeader>
                    </CustomForwardHeaders>
                  </AdditionalFeatures>
                </ContentTransformation>
              </TransformationConfiguration>
        ...
        self.assertEqual('GetObject-Range', result.object_process_configuration.allowed_features.allowed_feature[0])
        self.assertEqual('GetObject', result.object_process_configuration.transformation_configurations.transformation_configuration[0].actions.action[0])
        self.assertEqual('acs:ram::111933544165****:role/aliyunfcdefaultrole', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_assume_role_arn)
        self.assertEqual('acs:fc:cn-qingdao:111933544165****:services/test-oss-fc.LATEST/functions/fc-01', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.function_compute.function_arn)
        self.assertEqual('header1', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[0])
        self.assertEqual('header2', result.object_process_configuration.transformation_configurations.transformation_configuration[0].content_transformation.additional_features.custom_forward_headers.custom_forward_header[1])
        self.assertEqual('false', result.allow_anonymous_access_for_object_process)
