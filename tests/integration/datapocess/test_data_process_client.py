...
class TestDataProcess(TestIntegration):

    def test_do_meta_query_action(self):
        # null body
        try:
            self.client.do_meta_query_action(oss.DoMetaQueryActionRequest(
    ...
    def test_do_meta_query_action_required_field(self):
        # bucket
        try:
            self.client.do_meta_query_action(oss.DoMetaQueryActionRequest())
            self.fail("should not here")
    ...
    def test_do_data_pipeline_action(self):
        # null body
        try:
            self.client.do_data_pipeline_action(oss.DoDataPipelineActionRequest(
    ...
    def test_do_data_pipeline_action_required_field(self):
        # action
        try:
            self.client.do_data_pipeline_action(oss.DoDataPipelineActionRequest())
            self.fail("should not here")
