    ...
    def test_access_point_for_object_process(self):
        ...
        try:
            ...
            result = self.client.create_access_point_for_object_process(oss.CreateAccessPointForObjectProcessRequest(
                ...
                create_access_point_for_object_process_configuration=oss.CreateAccessPointForObjectProcessConfiguration(
                    ...
                    object_process_configuration=oss.ObjectProcessConfiguration(
                        allowed_features=oss.ObjectProcessAllowedFeatures(
                        ...
                        transformation_configurations=oss.TransformationConfigurations(
                            transformation_configuration=[oss.TransformationConfiguration(
                                ...
                                content_transformation=oss.ContentTransformation(
                                    function_compute=oss.ObjectProcessFunctionCompute(
                                    ...
                                    additional_features=oss.ObjectProcessAdditionalFeatures(
                                        custom_forward_headers=oss.ObjectProcessCustomForwardHeaders(
            ...
            while True:
                ...
                if list_result.access_points_for_object_process is None or list_result.access_points_for_object_process.access_point_for_object_process is None:
                ...
                for apop in list_result.access_points_for_object_process.access_point_for_object_process:
                        ...
                        transformation_configurations=oss.TransformationConfigurations(
                            transformation_configuration=[oss.TransformationConfiguration(
                                ...
                                content_transformation=oss.ContentTransformation(
                                    ...
                                    additional_features=oss.ObjectProcessAdditionalFeatures(
                                        custom_forward_headers=oss.ObjectProcessCustomForwardHeaders(
                                            custom_forward_header=['hx2ap1sXUg', 'i6p0Bo3wpj'],
                                        ),
                                    ),
                                ),
                            )],
