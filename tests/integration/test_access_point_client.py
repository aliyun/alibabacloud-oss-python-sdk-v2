...
class TestAccessPoint(TestIntegration):
    ...
    def test_access_point(self):
        ...
        try:
            ...
            self.assertEqual(200, result.status_code)
            self.assertEqual(access_point_name_1, result.access_points[0].access_point_name)
            ...
            self.assertEqual(200, result.status_code)
            self.assertEqual(access_point_name_2, result.access_points[0].access_point_name)
            self.assertEqual('internet', result.access_points[0].network_origin)
    ...
    def test_access_point_fail(self):
        ...
        try:
            self.client.create_access_point(oss.CreateAccessPointRequest(
                bucket=bucket_name,
                create_access_point_configuration=oss.CreateAccessPointConfiguration(
                    access_point_name=access_point_name_1,
                    network_origin='internet',
        ...
        try:
            self.client.get_access_point_policy(oss.GetAccessPointPolicyRequest(
                bucket=bucket_name,
                access_point_name=access_point_name_1,
            ))
            self.fail("should not here")
        ...
        try:
            self.client.list_access_points(oss.ListAccessPointsRequest(
                bucket=bucket_name,
                max_keys=1,
                continuation_token='',
            ))
        ...
        try:
            self.client.put_access_point_policy(oss.PutAccessPointPolicyRequest(
                bucket=bucket_name,
                access_point_name=access_point_name_1,
                body=policy,
            ))
        ...
        try:
            self.client.delete_access_point_policy(oss.DeleteAccessPointPolicyRequest(
                bucket=bucket_name,
                access_point_name=access_point_name_1,
            ))
            self.fail("should not here")
        ...
        try:
            self.client.delete_access_point(oss.DeleteAccessPointRequest(
                bucket=bucket_name,
                access_point_name=access_point_name_1,
            ))
            self.fail("should not here")
